#include "vga.h"
#include "string.h" /* Added string utility import */
...
/* Function to handle shared newline/scrolling logic */
...
void terminal_putchar(char c) {
    ...
    /* Handle Backspace */
        ...
        if (terminal_column > 0) {
            ...
            terminal_row--;
            terminal_column = VGA_WIDTH - 1; /* FIXED: VGA_WIDTH to VGA_WIDTH - 1 */
        }
